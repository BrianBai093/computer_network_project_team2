...
class TestCapture:
    ...
    def test_post_capture_with_image(self, client, node_state):
        # TODO: create a minimal valid PNG in memory and POST it
        pass
...
class TestVerify:
    ...
    def test_post_verify_unknown_image(self, client):
        # TODO: POST an image that has no on-chain record and assert result == UNKNOWN
        pass
